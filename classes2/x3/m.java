...
public final class m
{
    ...
    public m(@f final List<a> a, @f final DashboardStudentAbsence b) {
        this.a = a;
        this.b = b;
    }
    ...
    public final void c(@f final DashboardStudentAbsence b) {
        this.b = b;
    }
