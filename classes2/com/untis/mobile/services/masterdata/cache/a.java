...
public final class a extends e<AbsenceReason>
{
    ...
    public a(@org.jetbrains.annotations.e final String c, @org.jetbrains.annotations.e final d d) {
        k0.p(c, "profileId");
        k0.p(d, "realmService");
        this.c = c;
        this.d = d;
    ...
    @org.jetbrains.annotations.e
    @Override
    protected List<AbsenceReason> f() {
        final f0 c = this.d.c(this.c);
        try {
            final s0<b> b0 = c.f3(b.class).b0();
            k0.o(b0, "realm.where(RealmAbsenceReason::class.java)\n                            .findAll()");
            final ArrayList list = new ArrayList<AbsenceReason>(v.Y((Iterable<?>)b0, 10));
            for (final b b2 : b0) {
                final com.untis.mobile.utils.mapper.realmToModel.a a = com.untis.mobile.utils.mapper.realmToModel.a.a;
                k0.o(b2, "it");
                list.add(a.b(b2));
            }
            kotlin.io.c.a(c, null);
            return (List<AbsenceReason>)list;
        }
        finally {
            try {}
            finally {
    ...
    @Override
    protected void m(@org.jetbrains.annotations.e final List<AbsenceReason> list) {
        k0.p(list, "targets");
        j0.b(this.d.c(this.c), new l<f0, j2>() {
            public final void a(@org.jetbrains.annotations.e final f0 f0) {
                k0.p(f0, "realm");
                final List<AbsenceReason> g = list;
                final ArrayList list = new ArrayList<n0>(v.Y((Iterable<?>)g, 10));
                final Iterator<Object> iterator = g.iterator();
                while (iterator.hasNext()) {
                    list.add(com.untis.mobile.utils.mapper.realmToModel.a.a.c(iterator.next()));
                }
    ...
    @f
    protected AbsenceReason n(final long l) {
        final f0 c = this.d.c(this.c);
        try {
            ...
            final AbsenceReason b2 = com.untis.mobile.utils.mapper.realmToModel.a.a.b(b);
            kotlin.io.c.a(c, null);
            return b2;
        }
        finally {
