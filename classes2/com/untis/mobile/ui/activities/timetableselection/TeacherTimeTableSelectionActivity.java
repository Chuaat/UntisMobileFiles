...
import com.untis.mobile.ui.adapters.timetableselection.j;
import android.widget.ListView;
import com.untis.mobile.persistence.models.profile.Profile;
import com.untis.mobile.ui.activities.common.b;

public class TeacherTimeTableSelectionActivity extends b
{
    private static final String K = "superstar";
    private Profile G;
    private ListView H;
    private j I;
    private a J;
    ...
    private void s(@k0 final Bundle bundle) {
        ...
        final j0 g = j0.G;
        if ((this.G = g.l(extras.getString("superstar", ""))) == null) {
            this.G = g.n();
        }
    ...
    public static Intent v(final Context context, final Profile profile) {
        final Intent intent = new Intent(context, (Class)TeacherTimeTableSelectionActivity.class);
        final Bundle bundle = new Bundle();
        bundle.putString("superstar", profile.getUniqueId());
    ...
    protected void onCreate(@k0 final Bundle bundle) {
        ...
        final j j = new j((Context)this, this.G, this.J.h(true, com.untis.mobile.utils.time.a.b()));
        this.I = j;
        this.H.setAdapter((ListAdapter)j);
        this.H.setOnItemClickListener((AdapterView$OnItemClickListener)new c(this));
        final androidx.appcompat.app.a supportActionBar = this.getSupportActionBar();
        if (supportActionBar != null) {
            supportActionBar.z0(2131886783);
        ...
        if (searchView != null) {
            searchView.setOnQueryTextListener((SearchView$l)new SearchView$l() {
                public boolean onQueryTextChange(final String s) {
                    TeacherTimeTableSelectionActivity.this.I.n(s);
                    return true;
                }
    ...
    protected void onSaveInstanceState(final Bundle bundle) {
        ...
        bundle.putString("superstar", this.G.getUniqueId());
    }
}
