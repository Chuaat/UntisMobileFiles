...
public class i extends g
{
    ...
    public i(final float k, final float l, final float m, final float n, final float o) {
        super(k, l, m, n);
        this.K = k;
        this.L = l;
        this.M = m;
    ...
    void b(@j0 final Canvas canvas) {
        ...
        path.moveTo((this.M - this.K) / 40.0f + n, n2 - (this.N - this.L) / 8.0f);
        path.lineTo(n, n2);
        path.lineTo(n + (this.M - this.K) / 40.0f, n2 + (this.N - this.L) / 8.0f);
