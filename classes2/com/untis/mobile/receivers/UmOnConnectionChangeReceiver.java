...
public final class UmOnConnectionChangeReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(@f final Context context, @f final Intent intent) {
        if (g0.a(context)) {
            ...
            if (s.L1(action, "android.net.conn.CONNECTIVITY_CHANGE", false, 2, (Object)null)) {
                h.f((r0)b2.G, (g)null, (u0)null, (p)new UmOnConnectionChangeReceiver$onReceive.UmOnConnectionChangeReceiver$onReceive$1(this, context, (d)null), 3, (Object)null);
            }
        }
    }
    
    @Metadata(bv = { 1, 0, 3 }, d1 = { "\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0006\u0010\u0007J\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002¨\u0006\b" }, d2 = { "Lcom/untis/mobile/receivers/UmOnConnectionChangeReceiver$Companion;", "", "Landroid/content/Context;", "context", "Lkotlin/j2;", "register", "<init>", "()V", "untismobile_5.1.0_release" }, k = 1, mv = { 1, 5, 1 })
    public static final class Companion
    {
        ...
        public final void register(@e final Context context) {
            ...
            context.registerReceiver((BroadcastReceiver)new UmOnConnectionChangeReceiver(), intentFilter);
        }
    }
}
