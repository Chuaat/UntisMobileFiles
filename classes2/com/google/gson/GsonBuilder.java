...
public final class GsonBuilder
{
    ...
    GsonBuilder(final Gson gson) {
        ...
        this.longSerializationPolicy = LongSerializationPolicy.DEFAULT;
        this.fieldNamingPolicy = FieldNamingPolicy.IDENTITY;
        final HashMap<Object, Object> instanceCreators = new HashMap<Object, Object>();
        this.instanceCreators = (Map<Type, InstanceCreator<?>>)instanceCreators;
        final ArrayList<Object> factories = new ArrayList<Object>();
        this.factories = (List<TypeAdapterFactory>)factories;
        final ArrayList<Object> hierarchyFactories = new ArrayList<Object>();
        this.hierarchyFactories = (List<TypeAdapterFactory>)hierarchyFactories;
        this.serializeNulls = false;
        this.dateStyle = 2;
        this.timeStyle = 2;
        this.complexMapKeySerialization = false;
    ...
    public GsonBuilder registerTypeAdapter(final Type type, final Object o) {
        ...
        $Gson$Preconditions.checkArgument(b || o instanceof JsonDeserializer || o instanceof InstanceCreator || o instanceof TypeAdapter);
        if (o instanceof InstanceCreator) {
            this.instanceCreators.put(type, (InstanceCreator<?>)o);
        }
        if (b || o instanceof JsonDeserializer) {
    ...
    public GsonBuilder registerTypeHierarchyAdapter(final Class<?> clazz, final Object o) {
        final boolean b = o instanceof JsonSerializer;
        $Gson$Preconditions.checkArgument(b || o instanceof JsonDeserializer || o instanceof TypeAdapter);
        if (o instanceof JsonDeserializer || b) {
