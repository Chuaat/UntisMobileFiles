...
public final class j1<T, U> extends io.reactivex.internal.operators.maybe.a<T, T>
{
    ...
    public j1(final y<T> y, final y<U> h, final y<? extends T> i) {
        super(y);
        this.H = h;
        this.I = i;
    }
    ...
    static final class b<T, U> extends AtomicReference<c> implements v<T>, c
    {
        ...
        b(final v<? super T> g, final y<? extends T> i) {
            this.G = g;
            this.H = (j1.c<T, U>)new j1.c((b<Object, Object>)this);
            this.I = i;
            a<T> j;
            if (i != null) {
    ...
    static final class c<T, U> extends AtomicReference<io.reactivex.disposables.c> implements v<Object>
    {
        private static final long H = 8663801314800248617L;
        final b<T, U> G;
