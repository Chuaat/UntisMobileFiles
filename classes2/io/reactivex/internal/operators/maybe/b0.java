...
public final class b0<T> extends c
{
    ...
    public b0(final y<T> g, final o<? super T, ? extends i> h) {
        this.G = g;
        this.H = h;
    }
    ...
    static final class a<T> extends AtomicReference<io.reactivex.disposables.c> implements v<T>, f, io.reactivex.disposables.c
    {
