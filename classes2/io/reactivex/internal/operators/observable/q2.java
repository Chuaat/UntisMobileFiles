...
{
    final o<? super b0<Object>, ? extends g0<?>> H;
    
    public q2(final g0<T> g0, final o<? super b0<Object>, ? extends g0<?>> h) {
        super(g0);
        this.H = h;
    }
    ...
    static final class a<T> extends AtomicInteger implements i0<T>, c
    {
        ...
        a(final i0<? super T> g, final i<Object> j, final g0<T> m) {
            this.G = g;
            this.J = j;
            this.M = m;
