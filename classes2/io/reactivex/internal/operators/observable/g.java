...
public final class g<T> extends k0<Boolean> implements d<Boolean>
{
    final g0<T> G;
    final r<? super T> H;
    
    public g(final g0<T> g, final r<? super T> h) {
        this.G = g;
        this.H = h;
    }
    ...
    @Override
    public b0<Boolean> a() {
        return io.reactivex.plugins.a.R(new f((g0<Object>)this.G, (r<? super Object>)this.H));
    }
