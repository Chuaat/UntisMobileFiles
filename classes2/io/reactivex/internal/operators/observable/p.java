...
public final class p<T, U extends Collection<? super T>, B> extends io.reactivex.internal.operators.observable.a<T, U>
{
    ...
    public p(final g0<T> g0, final g0<B> h, final Callable<U> i) {
        super(g0);
        this.H = h;
        this.I = i;
    }
    ...
    protected void L5(final i0<? super U> p0) {
        ...
        //     4: new             Lio/reactivex/internal/operators/observable/p$b;
        //     7: dup            
        ...
        //    16: aload_0        
        //    17: getfield        io/reactivex/internal/operators/observable/p.I:Ljava/util/concurrent/Callable;
        //    20: aload_0        
        //    21: getfield        io/reactivex/internal/operators/observable/p.H:Lio/reactivex/g0;
        //    24: invokespecial   io/reactivex/internal/operators/observable/p$b.<init>:(Lio/reactivex/i0;Ljava/util/concurrent/Callable;Lio/reactivex/g0;)V
    ...
    static final class b<T, U extends Collection<? super T>, B> extends v<T, U, U> implements i0<T>, c
    {
        ...
        b(final i0<? super U> i0, final Callable<U> q0, final g0<B> r0) {
        ...
        public void b(final Throwable p0) {
            ...
            // Original Bytecode:
            // 
            //     1: invokevirtual   io/reactivex/internal/operators/observable/p$b.dispose:()V
            //     4: aload_0        
        ...
        public void dispose() {
            ...
            //    12: aload_0        
            //    13: getfield        io/reactivex/internal/operators/observable/p$b.t0:Lio/reactivex/disposables/c;
            //    16: invokeinterface io/reactivex/disposables/c.dispose:()V
            //    21: aload_0        
            //    22: getfield        io/reactivex/internal/operators/observable/p$b.s0:Lio/reactivex/disposables/c;
            //    25: invokeinterface io/reactivex/disposables/c.dispose:()V
            //    30: aload_0        
            //    31: invokevirtual   io/reactivex/internal/observers/v.e:()Z
            //    34: ifeq            46
            //    37: aload_0        
            //    38: getfield        io/reactivex/internal/observers/v.m0:Ly5/n;
        ...
        public void f() {
            ...
            //     1: monitorenter   
            //     2: aload_0        
            //     3: getfield        io/reactivex/internal/operators/observable/p$b.u0:Ljava/util/Collection;
            //     6: astore_1       
            //     7: aload_1        
            //     8: ifnonnull       14
            //    11: aload_0        
            ...
            //    14: aload_0        
            //    15: aconst_null    
            //    16: putfield        io/reactivex/internal/operators/observable/p$b.u0:Ljava/util/Collection;
            //    19: aload_0        
            //    20: monitorexit    
            //    21: aload_0        
        ...
        public void l(final c p0) {
            ...
            // Original Bytecode:
            // 
            //     1: getfield        io/reactivex/internal/operators/observable/p$b.s0:Lio/reactivex/disposables/c;
            //     4: aload_1        
            //     5: invokestatic    io/reactivex/internal/disposables/d.l:(Lio/reactivex/disposables/c;Lio/reactivex/disposables/c;)Z
            //     8: ifeq            107
            //    11: aload_0        
            //    12: aload_1        
            //    13: putfield        io/reactivex/internal/operators/observable/p$b.s0:Lio/reactivex/disposables/c;
            //    16: aload_0        
            //    17: getfield        io/reactivex/internal/operators/observable/p$b.q0:Ljava/util/concurrent/Callable;
            //    20: invokeinterface java/util/concurrent/Callable.call:()Ljava/lang/Object;
            //    25: ldc             "The buffer supplied is null"
            ...
            //    34: aload_0        
            //    35: aload_2        
            //    36: putfield        io/reactivex/internal/operators/observable/p$b.u0:Ljava/util/Collection;
            //    39: new             Lio/reactivex/internal/operators/observable/p$a;
            //    42: dup            
            //    43: aload_0        
            //    44: invokespecial   io/reactivex/internal/operators/observable/p$a.<init>:(Lio/reactivex/internal/operators/observable/p$b;)V
            //    47: astore_1       
            //    48: aload_0        
            //    49: aload_1        
            //    50: putfield        io/reactivex/internal/operators/observable/p$b.t0:Lio/reactivex/disposables/c;
            //    53: aload_0        
            //    54: getfield        io/reactivex/internal/observers/v.l0:Lio/reactivex/i0;
            //    57: aload_0        
            //    58: invokeinterface io/reactivex/i0.l:(Lio/reactivex/disposables/c;)V
            //    63: aload_0        
            //    64: getfield        io/reactivex/internal/observers/v.n0:Z
            //    67: ifne            107
            //    70: aload_0        
            //    71: getfield        io/reactivex/internal/operators/observable/p$b.r0:Lio/reactivex/g0;
            //    74: aload_1        
            //    75: invokeinterface io/reactivex/g0.c:(Lio/reactivex/i0;)V
            //    80: goto            107
            //    83: astore_2       
            //    84: aload_2        
            //    85: invokestatic    io/reactivex/exceptions/b.b:(Ljava/lang/Throwable;)V
            //    88: aload_0        
            //    89: iconst_1       
            //    90: putfield        io/reactivex/internal/observers/v.n0:Z
            //    93: aload_1        
            //    94: invokeinterface io/reactivex/disposables/c.dispose:()V
            //    99: aload_2        
            //   100: aload_0        
            //   101: getfield        io/reactivex/internal/observers/v.l0:Lio/reactivex/i0;
            //   104: invokestatic    io/reactivex/internal/disposables/e.l:(Ljava/lang/Throwable;Lio/reactivex/i0;)V
            //   107: return         
            //    Exceptions:
            //  Try           Handler
            //  Start  End    Start  End    Type
        ...
        void p() {
            ...
            //    19: monitorenter   
            //    20: aload_0        
            //    21: getfield        io/reactivex/internal/operators/observable/p$b.u0:Ljava/util/Collection;
            //    24: astore_2       
            //    25: aload_2        
            //    26: ifnonnull       32
            //    29: aload_0        
            ...
            //    32: aload_0        
            //    33: aload_1        
            //    34: putfield        io/reactivex/internal/operators/observable/p$b.u0:Ljava/util/Collection;
            //    37: aload_0        
            //    38: monitorexit    
            //    39: aload_0        
            //    40: aload_2        
            //    41: iconst_0       
            //    42: aload_0        
            //    43: invokevirtual   io/reactivex/internal/observers/v.k:(Ljava/lang/Object;ZLio/reactivex/disposables/c;)V
            //    46: return         
            //    47: astore_1       
            //    48: aload_0        
            //    49: monitorexit    
            ...
            //    57: aload_0        
            //    58: invokevirtual   io/reactivex/internal/operators/observable/p$b.dispose:()V
            //    61: aload_0        
            //    62: getfield        io/reactivex/internal/observers/v.l0:Lio/reactivex/i0;
            //    65: aload_1        
            //    66: invokeinterface io/reactivex/i0.b:(Ljava/lang/Throwable;)V
            //    71: return         
            //    Exceptions:
            //  Try           Handler
            //  Start  End    Start  End    Type
