...
public final class z0<T, R> extends io.reactivex.internal.operators.observable.a<T, R>
{
    ...
    public z0(final g0<T> g0, final o<? super T, ? extends y<? extends R>> h, final boolean i) {
        super(g0);
        this.H = h;
        this.I = i;
    }
    ...
    static final class a<T, R> extends AtomicInteger implements i0<T>, c
    {
        ...
        final o<? super T, ? extends y<? extends R>> L;
        final AtomicReference<io.reactivex.internal.queue.c<R>> M;
        c N;
        volatile boolean O;
        
        a(final i0<? super R> g, final o<? super T, ? extends y<? extends R>> l, final boolean h) {
            this.G = g;
            this.L = l;
            this.H = h;
            this.I = new b();
        ...
        void g(final z0.a.a a) {
            ...
            if (this.get() == 0) {
                ...
                if (this.compareAndSet(0, 1)) {
                    ...
                    final io.reactivex.internal.queue.c<R> c = this.M.get();
                    if (b && (c == null || c.isEmpty())) {
                        final Throwable c2 = this.K.c();
                        if (c2 != null) {
                            this.G.b(c2);
                        }
                        else {
        ...
        void h(final z0.a.a a, final Throwable t) {
            this.I.c(a);
            if (this.K.a(t)) {
                if (!this.H) {
                    this.N.dispose();
        ...
        public void m(final T t) {
            try {
                final y y = io.reactivex.internal.functions.b.g((y)this.L.apply((Object)t), "The mapper returned a null MaybeSource");
                this.J.getAndIncrement();
                final z0.a.a a = new z0.a.a();
        ...
        final class a extends AtomicReference<c> implements v<R>, c
        {
