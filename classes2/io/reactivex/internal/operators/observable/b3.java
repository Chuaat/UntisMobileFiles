...
public final class b3<T> extends k0<Boolean> implements d<Boolean>
{
    final g0<? extends T> G;
    final g0<? extends T> H;
    final x5.d<? super T, ? super T> I;
    final int J;
    
    public b3(final g0<? extends T> g, final g0<? extends T> h, final x5.d<? super T, ? super T> i, final int j) {
        this.G = g;
        this.H = h;
        this.I = i;
        this.J = j;
    ...
    @Override
    public b0<Boolean> a() {
        return io.reactivex.plugins.a.R((b0<Boolean>)new a3<Object>(this.G, this.H, this.I, this.J));
    }
    
    public void e1(final n0<? super Boolean> n0) {
        final a a = new a(n0, this.J, this.G, this.H, (x5.d<? super Object, ? super Object>)this.I);
        n0.l(a);
        a.d();
    }
    ...
    static final class a<T> extends AtomicInteger implements c
    {
        ...
        a(final n0<? super Boolean> g, final int n, final g0<? extends T> j, final g0<? extends T> k, final x5.d<? super T, ? super T> h) {
            this.G = g;
            this.J = j;
            this.K = k;
            this.H = h;
