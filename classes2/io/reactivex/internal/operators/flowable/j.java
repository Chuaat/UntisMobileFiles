...
public final class j<T> extends k0<Boolean> implements b<Boolean>
{
    final l<T> G;
    final r<? super T> H;
    
    public j(final l<T> g, final r<? super T> h) {
        this.G = g;
        this.H = h;
    }
    ...
    @Override
    public l<Boolean> g() {
        return io.reactivex.plugins.a.P(new i((l<Object>)this.G, (r<? super Object>)this.H));
    }
    ...
    static final class a<T> implements q<T>, c
    {
        ...
        @Override
        public boolean i() {
            return this.I == io.reactivex.internal.subscriptions.j.G;
        }
