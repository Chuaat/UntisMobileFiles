...
public final class c1<T, R> extends io.reactivex.internal.operators.flowable.a<T, R>
{
    ...
    public c1(final l<T> l, final o<? super T, ? extends y<? extends R>> i, final boolean j, final int k) {
        super(l);
        this.I = i;
        this.J = j;
        this.K = k;
    ...
    static final class a<T, R> extends AtomicInteger implements q<T>, d
    {
        ...
        final o<? super T, ? extends y<? extends R>> N;
        final AtomicReference<io.reactivex.internal.queue.c<R>> O;
        d P;
        volatile boolean Q;
        
        a(final c<? super R> g, final o<? super T, ? extends y<? extends R>> n, final boolean h, final int i) {
            this.G = g;
            this.N = n;
            this.H = h;
            this.I = i;
        ...
        void h(final c1.a.a a, final Throwable t) {
            this.K.c(a);
            if (this.M.a(t)) {
                if (!this.H) {
                    this.P.cancel();
        ...
        public void m(final T t) {
            try {
                final y y = io.reactivex.internal.functions.b.g((y)this.N.apply((Object)t), "The mapper returned a null MaybeSource");
                this.L.getAndIncrement();
                final c1.a.a a = new c1.a.a();
