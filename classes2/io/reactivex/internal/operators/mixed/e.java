...
public final class e<T, R> extends l<R>
{
    ...
    public e(final l<T> h, final o<? super T, ? extends q0<? extends R>> i, final j j, final int k) {
        this.H = h;
        this.I = i;
        this.J = j;
        this.K = k;
    ...
    static final class a<T, R> extends AtomicInteger implements q<T>, d
    {
        ...
        a(final c<? super R> g, final o<? super T, ? extends q0<? extends R>> h, final int i, final j n) {
            this.G = g;
            this.H = h;
            this.I = i;
            this.N = n;
                    ...
                    Label_0377: {
                        if (this.Q) {
                            ...
                            if (u == 0) {
                                ...
                                try {
                                    final q0 q0 = io.reactivex.internal.functions.b.g((q0)this.H.apply((Object)poll), "The mapper returned a null SingleSource");
                                    this.U = 1;
                                    q0.c(this.L);
                                    break Label_0377;
                                }
