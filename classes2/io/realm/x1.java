...
public class x1 extends k4.b implements p, y1
{
    ...
    public static k4.b A8(final f0 f0, final b b, final k4.b b2, final boolean b3, final Map<n0, p> map, final Set<q> set) {
        final x1 x1 = map.get(b2);
        if (x1 != null) {
            return x1;
        }
        final OsObjectBuilder osObjectBuilder = new OsObjectBuilder(f0.x2(k4.b.class), set);
        osObjectBuilder.L(b.e, b2.a());
        osObjectBuilder.d0(b.f, b2.g());
        osObjectBuilder.d0(b.g, b2.n());
        osObjectBuilder.K(b.h, b2.m0());
        final x1 n8 = N8(f0, osObjectBuilder.f0());
        map.put(b2, n8);
        return n8;
    }
    
    public static k4.b B8(final f0 f0, final b b, final k4.b b2, final boolean b3, final Map<n0, p> map, final Set<q> set) {
    ...
    public static k4.b D8(final k4.b b, final int a, final int n, final Map<n0, p.a<n0>> map) {
        if (a <= n && b != null) {
            final p.a a2 = map.get(b);
            k4.b b3;
            if (a2 == null) {
                final k4.b b2 = new k4.b();
    ...
    private static OsObjectSchemaInfo E8() {
        final OsObjectSchemaInfo.b b = new OsObjectSchemaInfo.b("", "RealmDuty", false, 4, 0);
    ...
    public static k4.b F8(final f0 f0, final JSONObject jsonObject, final boolean b) throws JSONException {
        final List<String> emptyList = Collections.emptyList();
        Object x2 = null;
        Label_0139: {
            if (b) {
                x2 = f0.x2(k4.b.class);
                final long e = ((b)f0.H().j(k4.b.class)).e;
                long r;
                ...
                if (r != -1L) {
                    final io.realm.a.h h = io.realm.a.W.get();
                    try {
                        h.g(f0, ((Table)x2).R(r), f0.H().j(k4.b.class), false, Collections.emptyList());
                        x2 = new x1();
                        break Label_0139;
                    }
                    finally {
        ...
        if (x2 == null) {
            ...
            x1 x3;
            if (jsonObject.isNull("id")) {
                x3 = f0.p1((Class<x1>)k4.b.class, null, true, emptyList);
            }
            else {
                x3 = f0.p1((Class<x1>)k4.b.class, jsonObject.getLong("id"), true, emptyList);
            }
            o = x3;
        }
        if (jsonObject.has("name")) {
            if (jsonObject.isNull("name")) {
                ...
                ((y1)o).e(jsonObject.getString("name"));
            }
        }
        if (jsonObject.has("longName")) {
            if (jsonObject.isNull("longName")) {
                ...
                ((y1)o).m(jsonObject.getString("longName"));
            }
        }
        if (jsonObject.has("type")) {
            ...
            ((y1)o).q0(jsonObject.getInt("type"));
        }
        return (k4.b)o;
    }
    
    @TargetApi(11)
    public static k4.b G8(final f0 f0, final JsonReader jsonReader) throws IOException {
        final k4.b b = new k4.b();
    ...
    public static long J8(final f0 f0, final k4.b b, final Map<n0, Long> map) {
        ...
        final Table x2 = f0.x2(k4.b.class);
        final long nativePtr = x2.getNativePtr();
        final b b2 = (b)f0.H().j(k4.b.class);
        final long e = b2.e;
        ...
        Table.nativeSetLong(nativePtr, b2.h, l, b.m0(), false);
        return l;
    }
    ...
    public static void K8(final f0 f0, final Iterator<? extends n0> iterator, final Map<n0, Long> map) {
        final Table x2 = f0.x2(k4.b.class);
        final long nativePtr = x2.getNativePtr();
        final b b = (b)f0.H().j(k4.b.class);
        final long e = b.e;
        while (iterator.hasNext()) {
            final k4.b b2 = (k4.b)iterator.next();
            ...
            Table.nativeSetLong(nativePtr, b.h, l, b2.m0(), false);
        }
    }
    
    public static long L8(final f0 f0, final k4.b b, final Map<n0, Long> map) {
        if (b instanceof p && !p0.h8(b)) {
            final p p3 = (p)b;
            if (p3.S6().f() != null && p3.S6().f().getPath().equals(f0.getPath())) {
                return p3.S6().g().l0();
        ...
        Table.nativeSetLong(nativePtr, b2.h, rowWithPrimaryKey, b.m0(), false);
    ...
    public static void M8(final f0 f0, final Iterator<? extends n0> iterator, final Map<n0, Long> map) {
        ...
        while (iterator.hasNext()) {
            ...
            Table.nativeSetLong(nativePtr, b.h, rowWithPrimaryKey, b2.m0(), false);
        }
    }
    
    static x1 N8(final io.realm.a a, final r r) {
        final io.realm.a.h h = a.W.get();
        h.g(a, r, a.H().j(k4.b.class), false, Collections.emptyList());
        final x1 x1 = new x1();
        h.a();
        return x1;
    }
    
    static k4.b O8(final f0 f0, final b b, final k4.b b2, final k4.b b3, final Map<n0, p> map, final Set<q> set) {
        final OsObjectBuilder osObjectBuilder = new OsObjectBuilder(f0.x2(k4.b.class), set);
        osObjectBuilder.L(b.e, b3.a());
        osObjectBuilder.d0(b.f, b3.g());
        osObjectBuilder.d0(b.g, b3.n());
        osObjectBuilder.K(b.h, b3.m0());
        osObjectBuilder.i0();
        return b2;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final String i = x1.O.g().g().M();
        if (m != null) {
            if (m.equals(i)) {
                return this.O.g().l0() == x1.O.g().l0();
            }
        }
        else if (i == null) {
            return this.O.g().l0() == x1.O.g().l0();
    ...
    public int m0() {
        this.O.f().h();
        return (int)this.O.g().m(this.N.h);
    }
    ...
    public String toString() {
        ...
        final StringBuilder sb = new StringBuilder("RealmDuty = proxy[");
        sb.append("{id:");
        sb.append(this.a());
        sb.append("}");
        sb.append(",");
    ...
    {
        public static final String a = "RealmDuty";
    }
    ...
    static final class b extends c
    {
        ...
        b(final OsSchemaInfo osSchemaInfo) {
            super(4);
            final OsObjectSchemaInfo b = osSchemaInfo.b("RealmDuty");
