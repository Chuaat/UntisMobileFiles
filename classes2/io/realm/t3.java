...
public class t3 extends v4.b implements p, u3
{
    ...
    public static v4.b B8(final v4.b b, final int a, final int n, final Map<n0, p.a<n0>> map) {
        if (a <= n && b != null) {
            final p.a a2 = map.get(b);
            v4.b b3;
            if (a2 == null) {
                final v4.b b2 = new v4.b();
    ...
    private static OsObjectSchemaInfo C8() {
        final OsObjectSchemaInfo.b b = new OsObjectSchemaInfo.b("", "RealmTeachingMethod", false, 3, 0);
    ...
    public static v4.b D8(final f0 f0, final JSONObject jsonObject, final boolean b) throws JSONException {
        final List<String> emptyList = Collections.emptyList();
        Object x2 = null;
        Label_0139: {
            if (b) {
                x2 = f0.x2(v4.b.class);
                final long e = ((b)f0.H().j(v4.b.class)).e;
                long r;
                ...
                if (r != -1L) {
                    ...
                    try {
                        h.g(f0, ((Table)x2).R(r), f0.H().j(v4.b.class), false, Collections.emptyList());
                        x2 = new t3();
                        break Label_0139;
                    }
                    finally {
        ...
        if (x2 == null) {
            ...
            t3 t3;
            if (jsonObject.isNull("id")) {
                t3 = f0.p1((Class<t3>)v4.b.class, null, true, emptyList);
            }
            else {
                t3 = f0.p1((Class<t3>)v4.b.class, jsonObject.getLong("id"), true, emptyList);
            }
            o = t3;
        }
        if (jsonObject.has("name")) {
            if (jsonObject.isNull("name")) {
                ...
                ((u3)o).e(jsonObject.getString("name"));
            }
        }
        if (jsonObject.has("longName")) {
            if (jsonObject.isNull("longName")) {
                ...
                ((u3)o).m(jsonObject.getString("longName"));
            }
        }
        return (v4.b)o;
    }
    ...
    @TargetApi(11)
    public static v4.b E8(final f0 f0, final JsonReader jsonReader) throws IOException {
        final v4.b b = new v4.b();
    ...
    public static long H8(final f0 f0, final v4.b b, final Map<n0, Long> map) {
        ...
        final Table x2 = f0.x2(v4.b.class);
        final long nativePtr = x2.getNativePtr();
        final b b2 = (b)f0.H().j(v4.b.class);
        final long e = b2.e;
    ...
    public static void I8(final f0 f0, final Iterator<? extends n0> iterator, final Map<n0, Long> map) {
        final Table x2 = f0.x2(v4.b.class);
        final long nativePtr = x2.getNativePtr();
        final b b = (b)f0.H().j(v4.b.class);
        final long e = b.e;
        while (iterator.hasNext()) {
            final v4.b b2 = (v4.b)iterator.next();
    ...
    public static long J8(final f0 f0, final v4.b b, final Map<n0, Long> map) {
        if (b instanceof p && !p0.h8(b)) {
            final p p3 = (p)b;
            if (p3.S6().f() != null && p3.S6().f().getPath().equals(f0.getPath())) {
                return p3.S6().g().l0();
    ...
    static t3 L8(final io.realm.a a, final r r) {
        final io.realm.a.h h = a.W.get();
        h.g(a, r, a.H().j(v4.b.class), false, Collections.emptyList());
        final t3 t3 = new t3();
        h.a();
        return t3;
    }
    
    static v4.b M8(final f0 f0, final b b, final v4.b b2, final v4.b b3, final Map<n0, p> map, final Set<q> set) {
        final OsObjectBuilder osObjectBuilder = new OsObjectBuilder(f0.x2(v4.b.class), set);
    ...
    public static v4.b y8(final f0 f0, final b b, final v4.b b2, final boolean b3, final Map<n0, p> map, final Set<q> set) {
        final t3 t3 = map.get(b2);
        if (t3 != null) {
            return t3;
        }
        final OsObjectBuilder osObjectBuilder = new OsObjectBuilder(f0.x2(v4.b.class), set);
        ...
        final t3 l8 = L8(f0, osObjectBuilder.f0());
        map.put(b2, l8);
        return l8;
    }
    
    public static v4.b z8(final f0 f0, final b b, final v4.b b2, final boolean b3, final Map<n0, p> map, final Set<q> set) {
        if (b2 instanceof p && !p0.h8(b2)) {
            final p p6 = (p)b2;
            if (p6.S6().f() != null) {
    ...
    public boolean equals(final Object o) {
        ...
        final String i = t3.N.g().g().M();
        if (m != null) {
            if (m.equals(i)) {
                return this.N.g().l0() == t3.N.g().l0();
            }
        }
        else if (i == null) {
            return this.N.g().l0() == t3.N.g().l0();
    ...
    public String toString() {
        ...
        final StringBuilder sb = new StringBuilder("RealmTeachingMethod = proxy[");
        sb.append("{id:");
        sb.append(this.a());
        sb.append("}");
        sb.append(",");
    ...
    {
        public static final String a = "RealmTeachingMethod";
    }
    ...
    static final class b extends c
    {
        ...
        b(final OsSchemaInfo osSchemaInfo) {
            super(3);
            final OsObjectSchemaInfo b = osSchemaInfo.b("RealmTeachingMethod");
