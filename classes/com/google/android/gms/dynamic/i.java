...
public final class i extends c.a
{
    ...
    private i(final Fragment f) {
        this.f = f;
    }
    
    @RecentlyNullable
    @a
    public static i y2(@k0 final Fragment fragment) {
        if (fragment != null) {
    ...
    public final void T1(@RecentlyNonNull final d d) {
        this.f.registerForContextMenu(x.k(com.google.android.gms.dynamic.f.y2(d)));
    }
    ...
    public final void o1(@RecentlyNonNull final d d) {
        this.f.unregisterForContextMenu(x.k(com.google.android.gms.dynamic.f.y2(d)));
    }
