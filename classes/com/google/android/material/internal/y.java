...
class y implements a0
{
    ...
    y(final Context context, final ViewGroup viewGroup, final View view) {
        this.a = new a(context, viewGroup, view, this);
    }
    
    static y e(final View view) {
        final ViewGroup f = b0.f(view);
        if (f != null) {
            ...
            return new v(f.getContext(), f, view);
        }
        return null;
    }
    ...
    static class a extends ViewGroup
    {
        ...
        a(final Context context, final ViewGroup g, final View h, final y j) {
            super(context);
            this.I = null;
            this.G = g;
            this.H = h;
