...
class v
{
    ...
    static o r(final o o, final o o2, final RectF rectF, final RectF rectF2, @t(from = 0.0, to = 1.0) final float n, @t(from = 0.0, to = 1.0) final float n2, @t(from = 0.0, to = 1.0) final float n3) {
        ...
        return B(o, o2, rectF, (d)new d() {
            ...
            public com.google.android.material.shape.d a(@j0 final com.google.android.material.shape.d d, @j0 final com.google.android.material.shape.d d2) {
                return new a(v.o(d.a(rectF), d2.a(rectF2), n, n2, n3));
            }
        });
    }
    
    static void s(final TransitionSet set, @k0 final Transition transition) {
        if (transition != null) {
            set.addTransition(transition);
        }
    }
    
    static boolean t(final Transition transition, final Context context, @f int e) {
        if (e != 0 && transition.getDuration() == -1L) {
            e = com.google.android.material.resources.b.e(context, e, -1);
            if (e != -1) {
                transition.setDuration((long)e);
                return true;
            }
        }
        return false;
    ...
    static boolean u(final Transition transition, final Context context, @f final int n, final TimeInterpolator timeInterpolator) {
        if (n != 0 && transition.getInterpolator() == null) {
            transition.setInterpolator(x(context, n, timeInterpolator));
            return true;
        }
        return false;
    }
    
    static boolean v(final Transition transition, final Context context, @f final int n) {
        if (n != 0) {
            final PathMotion y = y(context, n);
            if (y != null) {
    ...
    static void w(final TransitionSet set, @k0 final Transition transition) {
        if (transition != null) {
    ...
    @k0
    static PathMotion y(final Context context, @f int i) {
        final TypedValue typedValue = new TypedValue();
        ...
        if (i == 16) {
            ...
            if (i == 3) {
                return (PathMotion)new PatternPathMotion(androidx.core.graphics.o.e(String.valueOf(typedValue.string)));
            }
