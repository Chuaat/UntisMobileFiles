...
public final class ShadowDocument implements DocumentView
{
    ...
    @Override
    public ElementInfo getElementInfo(final Object key) {
        return this.mElementToInfoMap.get(key);
    }
    ...
    public final class Update implements DocumentView
    {
        ...
        private void removeGarbageSubTree(final Map<Object, ElementInfo> map, final Object o) {
            final ElementInfo elementInfo = map.get(o);
        ...
        private void validateTree(final Map<Object, ElementInfo> map) {
            ...
            for (final Map.Entry<Object, ElementInfo> entry : map.entrySet()) {
        ...
        public void commit() {
            if (ShadowDocument.this.mIsUpdating) {
                ...
                while (iterator.hasNext()) {
                    this.removeGarbageSubTree(ShadowDocument.this.mElementToInfoMap, iterator.next());
                }
                ShadowDocument.this.mIsUpdating = false;
                return;
            }
        ...
        @Override
        public ElementInfo getElementInfo(final Object key) {
            final ElementInfo elementInfo = this.mElementToInfoChangesMap.get(key);
            if (elementInfo != null) {
                return elementInfo;
            }
            return ShadowDocument.this.mElementToInfoMap.get(key);
        }
    ...
    public final class UpdateBuilder
    {
        ...
        private void setElementParent(final Object o, final Object o2) {
            ...
            final ElementInfo elementInfo2 = ShadowDocument.this.mElementToInfoMap.get(o);
        ...
        public void setElementChildren(final Object o, final List<Object> list) {
            ...
            if (elementInfo != null && elementInfo2 != null && elementInfo2.parentElement == elementInfo.parentElement && ListUtil.identityEquals((List<?>)list, (List<?>)elementInfo2.children)) {
                elementInfo3 = ShadowDocument.this.mElementToInfoMap.get(o);
                this.mElementToInfoChangesMap.remove(o);
            }
            else {
                Object o2;
            ...
            for (final Object next : acquireNotNewChildrenHashSet) {
                ...
                final ElementInfo elementInfo5 = ShadowDocument.this.mElementToInfoMap.get(next);
