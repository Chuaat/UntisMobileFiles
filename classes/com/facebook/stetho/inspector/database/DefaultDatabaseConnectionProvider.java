...
public class DefaultDatabaseConnectionProvider implements DatabaseConnectionProvider
{
    ...
    protected int determineOpenOptions(final File file) {
    ...
    protected SQLiteDatabase performOpen(final File file, @SQLiteDatabaseCompat.SQLiteOpenOptions final int n) {
