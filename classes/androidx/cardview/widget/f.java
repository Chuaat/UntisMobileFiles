...
class f extends Drawable
{
    ...
    f(final ColorStateList list, final float a) {
        this.f = false;
        this.g = true;
    ...
    private void i(final Rect rect) {
        ...
        this.d.set(bounds);
        if (this.f) {
            this.d.inset((int)Math.ceil(androidx.cardview.widget.g.c(this.e, this.a, this.g)), (int)Math.ceil(androidx.cardview.widget.g.d(this.e, this.a, this.g)));
            this.c.set(this.d);
        }
    }
    ...
    public void f(@k0 final ColorStateList list) {
        this.e(list);
        this.invalidateSelf();
    }
