...
public class x2
{
    public static final String a = "ROOM_CURSOR_MISMATCH";
    public static final String b = "ROOM_MISSING_JAVA_TMP_DIR";
    ...
    public static final String l = "MISSING_INDEX_ON_JUNCTION";
    public static final String m = "ROOM_DEFAULT_CONSTRUCTOR";
    public static final String n = "ROOM_RELATION_QUERY_WITHOUT_TRANSACTION";
    public static final String o = "ROOM_MISMATCHED_GETTER_TYPE";
    public static final String p = "ROOM_MISMATCHED_SETTER_TYPE";
