...
public class AppCompatImageButton extends ImageButton implements h0, x
{
    private final f G;
    private final l H;
    
    public AppCompatImageButton(@j0 final Context context) {
        this(context, null);
    }
    
    public AppCompatImageButton(@j0 final Context context, @k0 final AttributeSet set) {
        this(context, set, a.c.R1);
    }
    
    public AppCompatImageButton(@j0 final Context context, @k0 final AttributeSet set, final int n) {
        super(r0.b(context), set, n);
        p0.a((View)this, this.getContext());
        (this.G = new f((View)this)).e(set, n);
        (this.H = new l((ImageView)this)).f(set, n);
    }
