...
{
    b(final DatagramSocket datagramSocket, final FileDescriptor fileDescriptor) throws SocketException {
        super(new a(datagramSocket, fileDescriptor));
    }
    
    private static class a extends SocketImpl
    {
        a(final DatagramSocket datagramSocket, final FileDescriptor fd) {
